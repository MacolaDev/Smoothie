...
VertexBuffer PostProcessing::cube;
unsigned int PostProcessing::cubeVertexAttribue;
...
void PostProcessing::initPostProcessing()
{
    ...
    cube = VertexBuffer(cubeVertices, 288);
    glGenVertexArrays(1, &cubeVertexAttribue);
    VertexArrayObject::VertexAttributePointerXYZ(cubeVertexAttribue);
}
...
{
    glBindVertexArray(cubeVertexAttribue);
